    ...
    return (
        <div className='mt-3'>
            <div className='shadow p-4 rounded '>
                ...
                <h2 className='mt-3 text-3xl font-bold'>I am <span className='text-red-500'>Milon Mridha</span></h2>
                <h2 className='mt-3 text-xl font-bold'> Full Stack<span className='text-green-500'> Developer</span></h2>
